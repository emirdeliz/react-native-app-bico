...
export default class RecordAudio extends Component {
    ...
    componentDidMount() {
        let audioPath = AudioUtils.DocumentDirectoryPath + '/record-bico.aac'
        ...
        AudioRecorder.onProgress = (data) => {
            ...
            else if((data.currentTime + .001) >= this.state.recordTime)
                this.play(false);
        }
    ...
    render() {
        let buttonPlay = this.state.fileRecord?
            <Button rounded style={ Style.buttonPlay }
        ...
        return (
            <View style={ Style.containerButtons }>
                { buttonPlay }
                <Button rounded style={ Style.buttonRecord }
